...
<html lang="en">
	<head>
		...
		<title>Giao dịch mới | Admin</title>
	</head>
	<body>
				<!-- admin home page -->
		...
		<!-- main table -->
		<section id="new-transaction" class="order home-page">
			...
			<main class="p-4 right-content">
				...
				<div class="order-header d-flex justify-content-between">
					<div class="order-header-left mr-3">
						...
						<div>
							Ngày : <span class="date-transaction">12/2/2020</span>
						</div>
										...
										<div class="modal-body">
											<form action="">
												...
												<div class="form-group">
													...
													<input type="text" class="form-control" id="tea-price">
												</div>
												<div class="form-group">
