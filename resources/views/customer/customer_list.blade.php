	...
	<main class="right-content list-customer-content">
		...
		<div class="container mt-5">
			<div class="list-customer-header mt-4 d-flex">
				...
				/>
				<a href="create_order_ad.html" class="btn btn-primary">
					Tạo đơn mới <i class="fas fa-plus"></i>
				</a>
			</div>
				...
				<table class="table text-center">
					...
					<tbody>
						<tr>
							...
							<td>20.000.000đ</td>
							<td><a href="customer_details_ad.html">View</a></td>
							<td><a href="new_transaction_ad.html" class="btn btn-success">Giao dịch mới
						...
						<tr>
							...
							<td>Thôn B</td>
							<td>0837462632</td>
							<td>5000 <span class="mass-digit">kg</span></td>
							<td>20.000.000đ</td>
							<td><a href="customer_details_ad.html">View</a></td>
							<td><a href="new_transaction_ad.html" class="btn btn-success">Giao dịch mới
									<i class="fas fa-plus"></i></a></td>
